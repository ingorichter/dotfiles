...
#
# This is based on https://github.com/geerlingguy/dotfiles/blob/master/.osx from Jeff Geerling
...
defaults write com.apple.screencapture location -string "${HOME}/Nextcloud/Screenshots"
...
defaults write "Apple Global Domain" AppleAquaColorVariant -int 1
defaults write "Apple Global Domain" AppleHighlightColor -string "1.000000 0.874510 0.701961 Orange"
